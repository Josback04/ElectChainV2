import 'dart:math';
import 'package:tfc_vend_18_5h/controllers/election_controller.dart';
import 'package:tfc_vend_18_5h/controllers/user_controller.dart';
import 'package:tfc_vend_18_5h/models/models.dart';
import 'package:tfc_vend_18_5h/screens/home_screen.dart';
              ...
              slivers: [
                SliverAppBar(
                  leading: IconButton(
                      ...
                      onPressed: () => Get.to(tfc_vend_18_5h())),
                  title: Column(
                    children: [
                      Text(
                        election['name'] != null
